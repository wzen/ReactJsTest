...
// TODOをフィルタリング
var setVisiblilityFilter = exports.setVisiblilityFilter = function setVisiblilityFilter(filter) {
  return {
...
},{"../reducers/index":25}],3:[function(require,module,exports){
'use strict';
...
button.addEndEventListener('click', function () {
...
childList.filter(function (v) {
  ...
  v.addEventListener('click', function (e) {
    ...
    store.dispatch((0, _index.setVisiblilityFilter)(filterText));
  });
});

},{"../actions/index":1,"redux":20}],4:[function(require,module,exports){
...
},{"lodash/isPlainObject":13,"symbol-observable":22}],20:[function(require,module,exports){
(function (process){
'use strict';
